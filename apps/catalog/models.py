...
class Book(models.Model):
    ...
    #
    # NOTE: This is a strained example bc books can have multiple authors!
    ...
    # ManyToManyField used because genre can contain many books. Books can cover many generes.
...
class Author(models.Model):
    ...
    date_of_birth = models.DateField(
        'born', null=True, blank=True, help_text='Format: YYYY-MM-DD')
    date_of_death = models.DateField(
        'died', null=True, blank=True, help_text='Format: YYYY-MM-DD')
